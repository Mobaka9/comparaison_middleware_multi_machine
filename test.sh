...
result_file="rp7_$timestamp.csv"
...
for ((receivers=5; receivers<=50; receivers+=5)); do
    ...
    result=$(python3 main2.py --protocol ivy --port 10.34.127.255:7650 --ivybus_test_manager 10.34.127.255:1198 --length 10 --message_count 30000 --nbr_receivers $receivers --hosts vm-p2-ubuntu.achil.recherche.enac.fr vm-p4-ubuntu.achil.recherche.enac.fr --usernames achil | tail -n 1)
